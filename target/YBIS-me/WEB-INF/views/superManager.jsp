...
<head>
    ...
    <style>
        @import url(../../static/css/styleTwo.css);
    </style>
...
<header class="container-fluid" id="contain">
    <div class="main_nav">
        <img src="../../static/images/main_images/true.jpg" alt="">
        ...
        <ul id="main_nav_boot" >
            <li>
                <a href="/approval.do" target="kindergarten"> <span class="iconfont icon-kaoqin"></span><span>考勤管理</span></a>
            </li>
        </ul>
    </div>
    <div class="main_content">
            ...
            <div class="main_top_right">
                <div class="main_mail">
                    ...
                    <div class="main_mail_content">
                        ...
                        <ul>
                            <li>
                                <img src="../../static/images/main_images/face2.jpg" alt="">
                                <p>毛亮 <span>1分钟前</span></p>
                                <p>今晚值班</p>
                            </li>
                            <li>
                                <img src="../../static/images/main_images/face3.jpg" alt="" >
                                <p>刘德华 <span>10分钟前</span></p>
                                <p>今晚开演唱会</p>
                            </li>
                            <li>
                                <img src="../../static/images/main_images/face4.jpg" alt="" >
        ...
        <ul id="main_content_break">
            <li><a href="main.jsp" target="kindergarten"><span class="iconfont icon-shouye"></span><span>主页</span></a></li>
        </ul>
    </div>

    <iframe src="main.do" frameborder="0" name="kindergarten" id="main_Iframe"></iframe>
    ...
    $(document).ready(function () {
        ...
        for(let b=0;b<teacher.length;b++){
            if(teacher[b].teacherId==this_id){
                ...
                $("#main_nav_boot_two").append(`
                  <li><a href="erjieduan.jsp" target="kindergarten"><span class="iconfont icon-bianji"></span><span>班级管理</span></a></li>
                  <li><a href="stuInfor.jsp" target="kindergarten"><span class="iconfont icon-bianji"></span><span>学生管理</span></a></li>
                  `)
            }
        }
        for(let a=0;a<admin.length;a++){
            if(admin[a].username==this_id){
                ...
                $("#main_nav_boot_two").append(`
                  <li><a href="departInfo.jsp" target="kindergarten"><span class="iconfont icon-bianji"></span><span>部门管理</span></a></li>
                  <li><a href="teacher.jsp" target="kindergarten"><span class="iconfont icon-bianji"></span><span>职工管理</span></a></li>
                  <li><a href="erjieduan.jsp" target="kindergarten"><span class="iconfont icon-bianji"></span><span>班级管理</span></a></li>
                  <li><a href="stuInfor.jsp" target="kindergarten"><span class="iconfont icon-bianji"></span><span>学生管理</span></a></li>
                  `)
