...
<head>
    ...
    <style type="text/css">
        ...
        * {
        ...
        body {
            font-size: 12px;
            background:#06C url(/static/wallpapers/下载.jpg) no-repeat center center;
        ...
        .powered_by {
            ...
            height:25px;
            line-height:25px;
            background:url(/static/images/powered-by.png) no-repeat left center;
            color:#CCC;
            text-indent:26px;
            display:block;
            outline:none;
        ...
        #leftBtn a, #rightBtn a {
            ...
            height:40px;
            outline:none;
            background-image:url(/static/images/lr_btn.png);
        ...
        #task_lb a {
            ...
            width:100px;
            height:40px;
            background-image:url(/static/images/taskHdBtn.png);
            background-repeat:no-repeat;
            text-align:center;
            line-height:40px;
            float:right
        ...
        #shizhong_btn {
            background:url(/static/images/timer.png) no-repeat center center
        }
        #weather_btn {
            background:url(/static/images/wheather.png) no-repeat center center
        }
        #sound_btn {
            background:url(/static/images/sound_open.png) no-repeat center center
        }
        #showZm_btn {
            background:url(/static/images/show-desktop.png) no-repeat center center
        }
        #them_btn {
            background:url(/static/images/skin.png) no-repeat center center
        }
        /*侧边浮动栏*/
        #lr_bar {
            width:73px;
            ...
            left:0;
            top:30px;
            background:url(/static/images/dock_top.png) repeat-y left top;
        ...
        #start_block {
            ...
            left:0;
            bottom:-56px;
            background:url(/static/images/dock_b.png) no-repeat left bottom;
        ...
        #start_btn {
            ...
            width:48px;
            height:48px;
            background:url(/static/images/start-btn.png) no-repeat center bottom;
        ...
        #start_item {
            ...
            height:auto;
            padding:5px 0;
            background: url(/static/images/start_item_bg.png) repeat;
            position:absolute;
            z-index:500;
            left:75px;
            bottom:0px;
        ...
        #start_item .item li:hover {
            background:url(/static/images/start_item_over.png) repeat-x left bottom;
            cursor:pointer
        }
        #start_item .item li span {
            ...
            width:24px;
            height:24px;
            background-image:url(/static/images/start_itembtn.png);
            background-repeat:no-repeat;
            margin:0 10px;
            float:left;
        }
        #start_item .item li b {
            width:10px;
            height:24px;
            background:url(/static/images/item-child.png) no-repeat center center;
            display:inline-block;
            float:right;
            margin-right:10px;
        }
        ...
        #default_app .btnOver {
            background:url(/static/images/default_appbtn_bg.png) no-repeat center center
        }
        /*重写右键菜单样式*/
        ...
        .win_title {
            ...
            height:26px;
            line-height:26px;
            background:#E0E0E0 url(/static/images/titlebar_bg_cur.png) repeat-x left center;
            -moz-border-radius: 5px;
            -webkit-border-radius: 5px;
            border-radius: 5px;
        }
        ...
        .win_title .win_btnblock a {
            ...
            width:26px;
            height:17px;
            background-image:url(/static/images/windowBtn.png);
            background-repeat:no-repeat;
            float:left;
            margin:0 1px;
            outline:none;
        ...
        .desktop_icon .text {
            ...
            text-align:center;
            color:#fff;
            background:url(/static/images/iconTextbg.png) no-repeat left center;
            position:relative;
            padding-left:10px;
            margin-right:10px;
        }
        .desktop_icon .right_cron {
            ...
            right:-10px;
            top:0;
            background:url(/static/images/iconTextbg_right.png) left center no-repeat;
        }
        .desktop_icon_over {
            background:url(/static/images/icon_over.png) no-repeat center center;
        }
        -->
    </style>
    <link rel="stylesheet" href="/static/jsLib/themes/base/jquery.ui.all.css" />
    <link rel="stylesheet" href="/static/jsLib/jquery-smartMenu/css/smartMenu.css" />
    <script type="text/javascript" src="/static/jsLib/jquery-1.6.2.js"></script>
    <script type="text/javascript" src="/static/jsLib/myLib.js"></script>
    <script type="text/javascript" src="/static/jsLib/jquery-ui-1.8.16.custom.min.js"></script>
    <script type="text/javascript" src="/static/jsLib/jquery.winResize.js"></script>
    <script type="text/javascript" src="/static/jsLib/jquery-smartMenu/js/mini/jquery-smartMenu-min.js"></script>
...
<header id="header" class="container-fluid">
    ...
    <ul id="main_polaroids" class="main_polaroids col-lg-12 col-md-12">
...
<!--<ul id="deskIcon">
  <li class="desktop_icon" id="win5" path="http://www.jq22.com"> <span class="icon"><img src="icon/icon4.png"/></span>
    <div class="text">相册
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win6" path="http://www.jq22.com"> <span class="icon"><img src="icon/icon5.png"/></span>
    <div class="text">游戏
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win7" path="http://www.jq22.com"> <span class="icon"><img src="icon/icon6.png"/></span>
    <div class="text">日历
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win8" path="http://www.jq22.com"> <span class="icon"><img src="icon/icon7.png"/></span>
    <div class="text">聊天室
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win9" path="http://www.jq22.com"> <span class="icon"><img src="icon/icon8.png"/></span>
    <div class="text">通讯薄
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win10" path="http://www.jq22.com"> <span class="icon"><img src="icon/icon9.png"/></span>
    <div class="text">日记
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win11" path="http://www.jq22.com"> <span class="icon"><img src="icon/icon10.png"/></span>
    <div class="text">文档资料
      <div class="right_cron"></div>
    </div>
  </li>
...
<div id="lr_bar">
    <ul id="default_app">
        <li id="app0"><img src="/static/icon/新闻动态.png" title="学生动态" path=""/></li>
        <li  id="app2"><img src="/static/icon/公告登报.png" title="发布公告" path="http://www.jq22.com/?Material.aspx"/></li>
        <li id="app3"><img src="/static/icon/成绩.png" title="成绩表" path="http://www.jq22.com/?QQGroup.aspx"/></li>
        <li id="app4"> <img src="/static/icon/信息.png" title="在线留言" path="/login1.do"/></li>
    </ul>
